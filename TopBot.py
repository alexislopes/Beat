...
bot = telebot.TeleBot("474203343:AAG6ZAADnP_RUdSy9DL6bpb2QOglrhLnRjs")

address = 'C:\\Users\\alexi\\Desktop\\botzinho\\Cards\\'
...
def table_creator(nickname, name): # colocar um if no nickname
